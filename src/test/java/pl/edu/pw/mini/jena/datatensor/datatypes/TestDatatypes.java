...
public class TestDatatypes {
    ...
    public BaseDataTensor stringDataTensor = StringDataTensor.INSTANCE;
    ...
    @Test
    public void registration_string() {
        checkRegistration1(DataTensor.stringDataTensor, "StringDataTensor");
    }
    ...
    // ex:StringDataTensor
    @Test
    public void StringDataTensor_01() {
        valid(stringDataTensor, "{\"shape\":[2,1,2],\"data\":[\"3\",\"2\",\"3\",\"4\"]}");
        valid(stringDataTensor, "{\"shape\":[2,1,2],\"data\":[\"ab\",\"cd\",\"ef\",\"gh\"]}");
        valid(stringDataTensor, "{\"shape\":[2,2,1],\"data\":[\"abcd\",\"abcd\",\"superlonglongstring\",\"abcd\"]}");
        valid(stringDataTensor, "{\"shape\":[1,2,2],\"data\":[\"abcd\",\"abcd\",\"abcd\",\"abcd\"]}");
    }

    @Test
    public void StringDataTensor_02() {
        invalid(stringDataTensor, "{\"shape\":[1,2,2],\"data\":[3,2,3,4]}");
        invalid(stringDataTensor, "{\"shape\":[2,1,2],\"data\":[true, false, false, true]}");
        invalid(stringDataTensor, "{\"type\":\"string\",\"shape\":[2,1,2],\"data\":[true, false,3,4]}");
        invalid(stringDataTensor, "{\"type\":\"string\",\"shape\":[2,2,1],\"data\":[3,2,3,4]}");
        invalid(stringDataTensor, "{\"type\":\"string\",\"shape\":[1,2,2],\"data\":[3,2,3,4]}");
    }
