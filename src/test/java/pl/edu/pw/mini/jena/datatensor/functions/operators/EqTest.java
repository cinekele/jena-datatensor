...
public class EqTest {
    ...
    public void testExec2() {
        Eq eq = new Eq();
        NodeValue nodeValue1 = NodeValue.makeNode("{\"type\":\"float\",\"shape\":[4],\"data\":[1.0, 2.0, 1.0, 2.0]}", NumericDataTensor.INSTANCE);
        NodeValue nodeValue2 = NodeValue.makeNode("{\"type\":\"float\",\"shape\":[2, 2],\"data\":[1.0, 2.0, 1.0, 2.0]}", NumericDataTensor.INSTANCE);
        NodeValue resultNode = eq.exec(nodeValue1, nodeValue2);
        assertEquals(NodeValue.FALSE, resultNode);
    }
    ...
    public void testExec4() {
        Eq eq = new Eq();
        NodeValue nodeValue1 = NodeValue.makeNode("{\"type\":\"double\",\"shape\":[2],\"data\":[4E0, 8E0]}", NumericDataTensor.INSTANCE);
    ...
    public void testExec5() {
        Eq eq = new Eq();
        NodeValue nodeValue1 = NodeValue.makeNode("{\"type\":\"int\",\"shape\":[2],\"data\":[4, 8]}", NumericDataTensor.INSTANCE);
        NodeValue nodeValue2 = NodeValue.makeNode("{\"type\":\"int\",\"shape\":[2],\"data\":[4, 8]}", NumericDataTensor.INSTANCE);
        NodeValue resultNode = eq.exec(nodeValue1, nodeValue2);
        assertEquals(NodeValue.TRUE, resultNode);
    }
