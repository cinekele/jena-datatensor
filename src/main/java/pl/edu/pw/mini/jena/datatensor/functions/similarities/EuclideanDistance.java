...
public class EuclideanDistance extends GenericNumericDTFunctionBase2 {
    ...
    public NodeValue exec(NodeValue v1, NodeValue v2) {
        try {
            ...
            double euclideanSimilarity = Transforms.euclideanDistance(t1, t2);
            return NodeValue.makeDouble(euclideanSimilarity);
        } catch (Exception ex) {
