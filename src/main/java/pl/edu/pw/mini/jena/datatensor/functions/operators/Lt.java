...
public class Lt extends NumericDT2FunctionBase {
    ...
    public NodeValue calc(INDArray v1, INDArray v2) {
        ...
        INDArray v2Converted = v2.dataType().equals(dataType) ? v2 : v2.castTo(dataType);
        INDArray result = v1Converted.lt(v2Converted);
